...
@section('title', 'Nouvel Événement - Gestion Kourel')
...
<div class="min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div class="flex items-center">
                    <h1 class="text-3xl font-bold text-white"><i class="fas fa-plus mr-3"></i>Nouvel Événement</h1>
                </div>
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 mt-24">
        ...
        <div class="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20">
            <form id="formCreateEvenement" class="space-y-6">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <textarea id="configuration" name="configuration" rows="3"
                              class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-white/50"
                              placeholder='{"dress_code": "tenue traditionnelle", "transport": "organise"}'></textarea>
...
document.getElementById('formCreateEvenement').addEventListener('submit', function(e) {
    e.preventDefault();
    ...
    .then(data => {
        if (data.success) {
            ...
            window.location.href = `/evenements/${data.evenement.id}`;
        } else {
            if (typeof alerteModerne !== 'undefined' && alerteModerne.toast) {
